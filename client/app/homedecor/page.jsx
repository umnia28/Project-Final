...
export default function DecorProductsPage() {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const res = await fetch(`${API}/api/products?search=Decor`);
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="mb-8 overflow-hidden rounded-[2rem] border border-[#ebe7f5] bg-[linear-gradient(180deg,rgba(255,255,255,0.92),rgba(248,249,255,0.92))] p-6 shadow-[0_18px_45px_rgba(180,160,255,0.08)] md:p-8">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-500 md:text-base">
            Explore graceful décor pieces curated with elegance, texture, and
            artistic warmth to elevate your living spaces.
          </p>
        </div>
