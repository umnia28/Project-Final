  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[linear-gradient(180deg,#fcfcfa_0%,#f8fbff_55%,#faf7ff_100%)] px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="relative mx-auto max-w-7xl">
        {/* HERO */}
        <div className="mb-8 rounded-[2rem] border border-[#ebe7f5] bg-white/90 p-6 shadow">
          <div className="inline-flex items-center gap-2 rounded-full border px-4 py-1 text-xs uppercase tracking-wider text-slate-600">
            <Sparkles className="h-3.5 w-3.5 text-violet-500" />
            Curated Collection
          </div>

          <h1 className="mt-5 text-3xl font-semibold text-slate-800 md:text-5xl">
            Decor Products
          </h1>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[280px_1fr]">
          {/* SIDEBAR */}
          <aside className="rounded-[2rem] border bg-white p-5 shadow">
            <div className="mb-5 flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-full bg-purple-100 text-violet-500">
                <Layers3 size={18} />
              </div>
              <div>
