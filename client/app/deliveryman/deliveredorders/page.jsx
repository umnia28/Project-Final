...
const getItemLineTotal = (item) =>
  Number(item.line_total ?? (Number(item.price || 0) * Number(item.qty || 0)));
          ...
          <div className="space-y-6">
            {deliveredOrders.map((order) => {
              const itemsTotal = Number(
                getDeliveredOrderActualAmount(order) || 0
              );
              const promoDiscount = Number(order.discount_amount || 0);
              const finalOrderTotal = Number(order.total_price || 0);
                ...
                >
                      ...
                      <div className="mt-4 space-y-2">
                        ...
                        <p className="text-sm text-slate-600">
                          ...
                          <span className="font-semibold">
                            ...
                            "cod"
                              ? Number(order.collected_amount || 0).toLocaleString()
                              : Number(
                                  order.actual_amount || order.total_price || 0
                                ).toLocaleString()}
                          </span>
                        </p>
                        ...
                        <div className="mt-3 space-y-1 text-sm text-slate-600">
                          ...
                          {promoDiscount > 0 && (
                            <p className="text-emerald-600">
                              Promo Applied: -৳ {promoDiscount.toLocaleString()}
                            </p>
                          )}
                  ...
                  <div className="mt-5 space-y-4">
                    {order.deliveredItems.map((item) => {
                      ...
                      const discountTotal = Number(item.discount_amount || 0);
...
//                               getDeliveredOrderActualAmount(order) ??
//                               0
//                           ).toLocaleString()}
//                         </span>
//                       </p> */}
...
//                           {String(order.payment_method || "").toLowerCase() === "cod"
//                             ? Number(order.collected_amount || 0).toLocaleString()
//                             : Number(order.actual_amount || order.total_price || 0).toLocaleString()}
//                         </span>
//                       </p>
...
//                                 </p>
//                                 <p className="text-sm font-medium text-slate-700">
//                                   After Discount: ৳ {lineTotal.toLocaleString()}
//                                 </p>
//                               </>
//                             ) : (
//                               <p className="text-sm text-slate-500">
