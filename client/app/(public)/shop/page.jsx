...
function ShopContent() {
  ...
  return (
    <div className="relative min-h-[70vh] overflow-hidden px-6">
      <div className="pointer-events-none absolute inset-0 -z-20 bg-[linear-gradient(to_bottom,#fcfcfa,#f8fbff,#faf7ff)]" />
      <div className="pointer-events-none absolute -top-20 left-0 -z-10 h-72 w-72 rounded-full bg-[#dbeafe]/30 blur-3xl" />
      <div className="pointer-events-none absolute top-32 right-0 -z-10 h-80 w-80 rounded-full bg-[#e9d5ff]/25 blur-3xl" />
      <div className="pointer-events-none absolute bottom-0 left-1/3 -z-10 h-72 w-72 rounded-full bg-[#f5f5dc]/30 blur-3xl" />

      <div className="max-w-7xl mx-auto py-8">
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-[#e5e7f0] bg-[linear-gradient(90deg,#eff6ff,#f5f3ff,#faf8ef)] px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.25em] text-slate-700 shadow-sm">
              <Sparkles className="h-3.5 w-3.5 text-violet-500" />
              Charis Atelier Collection
            </div>

            <h1 className="mt-4 text-3xl sm:text-4xl font-semibold bg-gradient-to-r from-sky-500 via-violet-500 to-indigo-400 bg-clip-text text-transparent">
          ...
          {filteredProducts.length > 0 ? (
            ...
            <div className="flex min-h-[260px] items-center justify-center">
              <div className="rounded-[1.75rem] border border-[#ebe7f5] bg-[linear-gradient(to_bottom_right,rgba(255,255,255,0.88),rgba(239,246,255,0.75),rgba(245,243,255,0.72))] px-8 py-12 text-center shadow-[0_15px_40px_rgba(180,160,255,0.08)]">
                <h2 className="bg-gradient-to-r from-sky-500 via-violet-500 to-indigo-400 bg-clip-text text-2xl font-semibold text-transparent">
                  No products found
                </h2>
...
export default function Shop() {
  return (
    <Suspense
      fallback={
        <div className="min-h-[70vh] flex items-center justify-center px-6 bg-[linear-gradient(to_bottom,#fcfcfa,#f8fbff,#faf7ff)]">
