...
//   // 🔥 FIXED NORMALIZATION (REDUX DATA)
//   const reduxProduct = useMemo(() => {
//     const found = products.find(
//       (item) => String(item?.id ?? item?.product_id) === String(productId)
//     );
...
//       found.discount_percent ?? found.discount ?? 0
//     );

//     const finalPrice = Number(found.price ?? 0);

//     // ✅ FIX: calculate base price correctly from %
//     const basePrice =
//       found.base_price ??
//       found.mrp ??
//       (discountPercent > 0
...
//     // ✅ FIX: correct discount amount
//     const discountAmount =
//       found.discount_amount !== undefined && found.discount_amount !== null
//         ? Number(found.discount_amount)
//         : Math.round((basePrice * discountPercent) / 100);
...
// //     const finalPrice = Number(found.price ?? 0);
// //     const basePrice = Number(found.base_price ?? found.mrp ?? finalPrice);
// //     const discountPercent = Number(
// //       found.discount_percent ?? found.discount ?? 0
// //     );
// //     const discountAmount =
...
// //       const finalPrice = Number(p.price ?? 0);
// //       const basePrice = Number(p.base_price ?? p.mrp ?? finalPrice);
// //       const discountPercent = Number(p.discount_percent ?? p.discount ?? 0);
// //       const discountAmount =
// //         p.discount_amount !== undefined && p.discount_amount !== null
// //           ? Number(p.discount_amount)
