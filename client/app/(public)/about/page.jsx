  ...
  return (
    <div className="relative overflow-hidden px-6 py-12">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {/* Main card */}
        <div className="rounded-[2rem] border border-white/60 bg-white/70 p-6 sm:p-8 md:p-10 shadow-[0_20px_70px_rgba(167,139,219,0.08)] backdrop-blur-xl">
          <div className="grid gap-8 lg:grid-cols-[1.3fr_0.7fr]">
            ...
            <div className="space-y-4">
              <div className="rounded-[1.5rem] border border-white/70 bg-gradient-to-br from-[#f7f1e8] via-white to-[#eef6ff] p-5 shadow-sm">
                <div className="flex items-center gap-3">
                  <div className="flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-r from-[#d8c3a5] via-[#a78bdb] to-[#7fb6ea] text-white shadow">
                    <Gem size={18} />
                  </div>
                  <div>
              ...
              <div className="rounded-[1.5rem] border border-white/70 bg-gradient-to-br from-[#efe7fb] via-white to-[#f7f1e8] p-5 shadow-sm">
                <div className="flex items-center gap-3">
                  <div className="flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-r from-[#a78bdb] via-[#7fb6ea] to-[#d8c3a5] text-white shadow">
              ...
              <div className="rounded-[1.5rem] border border-white/70 bg-gradient-to-br from-[#eef6ff] via-white to-[#efe7fb] p-5 shadow-sm">
                <div className="flex items-center gap-3">
                  <div className="flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-r from-[#7fb6ea] via-[#a78bdb] to-[#d8c3a5] text-white shadow">
                    <Eye size={18} />
                  </div>
                  <div>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            <div className="rounded-[1.75rem] border border-white/70 bg-gradient-to-br from-white/90 via-[#efe7fb]/70 to-[#eef6ff]/60 p-6 shadow-[0_15px_40px_rgba(167,139,219,0.08)]">
              <h2 className="text-2xl font-semibold bg-gradient-to-r from-[#a78bdb] via-[#7fb6ea] to-[#d8c3a5] bg-clip-text text-transparent">
                Our Mission
              </h2>
            ...
            <div className="rounded-[1.75rem] border border-white/70 bg-gradient-to-br from-white/90 via-[#f7f1e8]/70 to-[#efe7fb]/60 p-6 shadow-[0_15px_40px_rgba(127,182,234,0.08)]">
              <h2 className="text-2xl font-semibold bg-gradient-to-r from-[#d8c3a5] via-[#a78bdb] to-[#7fb6ea] bg-clip-text text-transparent">
                Our Vision
              </h2>
              <p className="mt-4 text-slate-600 leading-8">
