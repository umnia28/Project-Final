    ...
    <div className="min-h-screen px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-6 grid gap-8 xl:grid-cols-[1.2fr_0.8fr]">
          <div className="overflow-hidden rounded-[2rem] border border-[#e5dfec] bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(244,248,255,0.96))] shadow-[0_18px_45px_rgba(140,152,190,0.08)]">
            <div
              className="pointer-events-none absolute opacity-0"
              aria-hidden="true"
            />

            <div className="border-b border-[#e7e0f0] px-5 py-4 sm:px-7">
              <div className="flex items-center gap-3">
                <div className="rounded-full border border-[#ddd3ea] bg-[#f7f1e8] p-2.5">
                  <ShoppingBag className="h-4 w-4 text-[#8d79c8]" />
                </div>
                <div>
                  <h2 className="font-display text-2xl font-medium tracking-tight text-slate-800">
                    Cart Items
                  </h2>
                  ...
                  >
                    <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                      <div className="flex min-w-0 items-start gap-4">
                        <div className="relative flex h-24 w-24 shrink-0 items-center justify-center overflow-hidden rounded-[1.4rem] border border-[#e8e2ef] bg-gradient-to-br from-[#fffdf9] via-[#f6f1fb] to-[#eef6ff] shadow-[0_10px_24px_rgba(140,152,190,0.08)]">
                          <Image
                            src={itemImage}
                          ...
                          />
                          <div className="pointer-events-none absolute bottom-2 left-1/2 h-5 w-[62%] -translate-x-1/2 rounded-full bg-[#a78bdb]/15 blur-xl" />
                        </div>
                          ...
                          <div className="mt-2">
                            ...
                            {item.discount_percent > 0 && (
                              <p className="text-xs text-emerald-600">
                                Save {item.discount_percent}% ({currency}
...
>>>>>>> origin/shreya_branch
                          ...
                          <div className="mt-3">
                            {isOutOfStock ? (
                              <span className="inline-flex items-center gap-2 rounded-full bg-[#f4edff] px-3 py-1.5 text-xs font-semibold text-[#7b5ab8]">
                                <PackageX size={13} />
                                Out of stock
                              </span>
                            ) : exceedsStock ? (
                              <span className="inline-flex items-center gap-2 rounded-full bg-[#f7f1e8] px-3 py-1.5 text-xs font-semibold text-[#a07d57]">
                                <AlertTriangle size={13} />
                                Only {stock} item(s) available
                              </span>
                            ) : stock <= 5 ? (
                              <span className="inline-flex items-center gap-2 rounded-full bg-[#eef6ff] px-3 py-1.5 text-xs font-semibold text-[#5f91c5]">
                                <ShoppingBag size={13} />
                                Only {stock} left
                              </span>
                            ) : (
                          ...
                          <div>
                            {item.discount_percent > 0 && (
                              <p className="text-xs text-slate-400 line-through">
                                {currency}
                                {Number(item.original_line_total).toLocaleString()}
                              </p>
                            )}
                            ...
                            {item.discount_percent > 0 && (
                              <p className="text-xs text-emerald-600">
                                -{currency}
                                {Number(item.line_discount).toLocaleString()}
                              </p>
                            )}
                          </div>
=======
...
>>>>>>> origin/shreya_branch
          ...
          <div className="w-full">
            {hasInvalidItems && (
              <div className="mb-5 rounded-[1.5rem] border border-[#e0d6ee] bg-[linear-gradient(180deg,#faf7ff,#f2eeff)] p-4 shadow-[0_10px_24px_rgba(167,139,219,0.08)]">
                <div className="flex items-start gap-3">
                  <div className="rounded-full bg-[#f1ebfb] p-2">
                    <AlertTriangle className="h-4 w-4 text-[#8b72c4]" />
                  </div>
                  <div>
                    <p className="font-semibold text-[#7c63b6]">
                      Some items need attention
                    </p>
                    <p className="mt-1 text-sm text-[#8f7abf]">
            ...
            <div className="rounded-[2rem] border border-[#e5dfec] bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(244,248,255,0.96))] p-1 shadow-[0_18px_45px_rgba(140,152,190,0.08)]">
              <OrderSummary
    ...
    <div className="flex min-h-[80vh] items-center justify-center px-6">
      <div className="w-full max-w-xl rounded-[2rem] border border-[#e5dfec] bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(244,248,255,0.96))] px-8 py-14 text-center shadow-[0_18px_45px_rgba(140,152,190,0.08)]">
        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full border border-[#ddd3ea] bg-[#f7f1e8]">
          <ShoppingBag className="h-7 w-7 text-[#8d79c8]" />
        </div>

        <h1 className="mt-5 font-display text-3xl font-medium tracking-tight text-slate-800 sm:text-4xl">
          Your cart is empty
        </h1>
