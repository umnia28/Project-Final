...
export default function ArtProductsPage() {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const res = await fetch(`${API}/api/products?search=Art`);
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[linear-gradient(180deg,#fcfcfa_0%,#f8fbff_55%,#faf7ff_100%)] px-4 py-8 sm:px-6 lg:px-8">
      <div className="absolute -top-16 -left-16 h-72 w-72 rounded-full bg-[#dbeafe]/35 blur-3xl" />
      <div className="absolute top-20 right-0 h-80 w-80 rounded-full bg-[#e9d5ff]/30 blur-3xl" />
      <div className="absolute bottom-0 left-1/3 h-72 w-72 rounded-full bg-[#f5f5dc]/35 blur-3xl" />

      <div className="relative mx-auto max-w-7xl">
        <div className="mb-8 overflow-hidden rounded-[2rem] border border-[#ebe7f5] bg-[linear-gradient(180deg,rgba(255,255,255,0.92),rgba(248,249,255,0.92))] p-6 shadow-[0_18px_45px_rgba(180,160,255,0.08)] md:p-8">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#e5e7f0] bg-[linear-gradient(90deg,#eff6ff,#f5f3ff,#faf8ef)] px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.24em] text-slate-600">
            <Sparkles className="h-3.5 w-3.5 text-violet-500" />
            Curated Collection
          </div>

          <h1 className="mt-5 text-3xl font-semibold tracking-tight text-slate-800 md:text-5xl">
            Art Products
          </h1>

          <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-500 md:text-base">
            Explore expressive artworks, creative pieces, and beautifully crafted
            designs that bring inspiration, emotion, and quiet elegance into your
            space.
          </p>
        </div>

        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[280px_1fr]">
          <aside className="h-fit rounded-[2rem] border border-[#ebe7f5] bg-[linear-gradient(180deg,rgba(255,255,255,0.92),rgba(248,249,255,0.92))] p-5 shadow-[0_18px_45px_rgba(180,160,255,0.08)]">
            <div className="mb-5 flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-full bg-[linear-gradient(135deg,#eff6ff,#f5f3ff)] text-violet-500 shadow-sm">
                <Layers3 size={18} />
              </div>
              <div>
                ...
                <p className="text-xs text-slate-400">Browse by style</p>
              </div>
            </div>
                ...
                <button
                  ...
                  className={`w-full rounded-xl px-4 py-3 text-left text-sm font-semibold transition-all duration-300 ${
                    selectedCategory === cat
                      ? "bg-[linear-gradient(90deg,#dbeafe,#e9d5ff,#f5f5dc)] text-slate-700 shadow-[0_10px_22px_rgba(180,160,255,0.12)]"
                      : "border border-[#ebe7f5] bg-white text-slate-600 hover:-translate-y-0.5 hover:bg-[#f8fbff]"
                  }`}
                >
                  {cat}
                </button>
          ...
          <section>
            {loading ? (
              <div className="rounded-[2rem] border border-[#ebe7f5] bg-[linear-gradient(180deg,rgba(255,255,255,0.92),rgba(248,249,255,0.92))] p-10 text-center text-slate-500 shadow-[0_18px_45px_rgba(180,160,255,0.08)]">
                Loading products...
              </div>
...
//             Explore expressive artworks, creative pieces, and beautifully crafted
//             designs that bring inspiration, emotion, and quiet elegance into your space.
//           </p>
//         </div>
