    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(219,234,254,0.24),_transparent_28%),radial-gradient(circle_at_bottom_right,_rgba(196,181,253,0.22),_transparent_30%),linear-gradient(to_bottom,_#fcfcfa,_#f8fbff,_#faf7ff)] text-slate-800">
      <div className="max-w-6xl mx-auto px-4 py-10 md:py-14">
        <div className="bg-white/85 backdrop-blur-md border border-[#ebe7f5] rounded-3xl shadow-[0_16px_40px_rgba(180,160,255,0.10)] overflow-hidden">
          <div className="bg-gradient-to-r from-[#dbeafe] via-[#e9d5ff] to-[#f5f5dc] px-6 md:px-10 py-10">
            <p className="text-sm uppercase tracking-[0.25em] text-slate-500">
              Legal & Safety
            </p>
            <h1 className="text-3xl md:text-5xl font-bold mt-3 text-slate-900">
              Privacy Policy
            </h1>
            <p className="text-slate-600 mt-4 max-w-3xl leading-7">
          ...
          <div className="px-6 md:px-10 py-8 md:py-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {sections.map((section, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="border border-[#ebe7f5] rounded-2xl p-5 bg-[linear-gradient(180deg,#ffffff,#f8fbff)] hover:shadow-[0_10px_24px_rgba(180,160,255,0.08)] transition"
                  >
            ...
            <div className="mt-8 border border-[#ebe7f5] rounded-2xl p-5 md:p-6 bg-[linear-gradient(90deg,#eff6ff,#f5f3ff,#faf8ef)]">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              <Link
                href="/"
                className="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-[#dbeafe] via-[#c4b5fd] to-[#f5f5dc] text-slate-700 px-5 py-3 font-semibold hover:opacity-90 transition shadow-[0_10px_22px_rgba(180,160,255,0.14)]"
              >
                Back to Home
              </Link>
              ...
              <Link
                href="/contact"
                className="inline-flex items-center justify-center rounded-xl border border-[#d8dbe7] bg-white px-5 py-3 text-slate-700 hover:bg-[#f8fbff] transition"
              >
                Contact Support
              </Link>
            </div>
