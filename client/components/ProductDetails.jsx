...
const ProductDetails = ({
  ...
  const displayPrice =
    matchedVariantWithPrice?.new_price ?? normalized?.price ?? 0;
  ...
  const discountPercent =
    displayMrp && displayMrp > displayPrice
      ...
      : Number(normalized?.discount_percent || 0);
          ...
          <div className="relative mt-7 rounded-[1.5rem] border border-[#e5dfec] bg-gradient-to-r from-[#fffdfa] via-[#f5f0fb] to-[#eef6ff] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.55)]">
            ...
            {discountPercent > 0 ? (
              <div className="mt-3 space-y-1">
                <div className="inline-flex items-center gap-2 text-sm font-medium text-[#8b7bd6]">
                  <TagIcon size={15} />
                ...
                <p className="text-sm text-emerald-600">
                  You save {currency}
                  {Number(
                    displayMrp ? displayMrp - displayPrice : normalized.discount_amount || 0
                  ).toLocaleString()}
                </p>
              </div>
            ) : (
...
//                 {currency}
// <<<<<<< HEAD
//                 {Number(normalized.price).toLocaleString()}
// =======
//                 {Number(displayPrice).toLocaleString()}
// >>>>>>> origin/shreya_branch
//               </p>
...
//                   {currency}
// <<<<<<< HEAD
//                   {Number(normalized.mrp).toLocaleString()}
// =======
//                   {Number(displayMrp).toLocaleString()}
// >>>>>>> origin/shreya_branch
//                 </p>
...
//                 <p className="text-sm text-emerald-600">
//                   You save {currency}
//                   {Number(normalized.discount_amount || 0).toLocaleString()}
//                 </p>
//               </div>
//             ) : (
//               <div className="mt-3 inline-flex items-center gap-2 text-sm font-medium text-slate-500">
