...
const ProductDetails = ({ product }) => {
  ...
  return (
    <div className="grid gap-10 lg:grid-cols-[1.02fr_0.98fr] lg:gap-14">
      <div className="relative">
        ...
        <div className="relative z-10 flex flex-col gap-4 md:flex-row">
              ...
              return (
                <button
                  ...
                  className={`group relative h-24 w-24 overflow-hidden rounded-[22px] border bg-white transition-all duration-300 ${
                    isSelected
                      ? "border-[#d9c4a3] ring-2 ring-[#efe2cf]"
                      : "border-[#ece7de] hover:border-[#d8cfbf]"
                  }`}
                >
                  <Image
                    src={thumbSrc}
                    ...
                    fill
                    className="object-cover p-1.5 transition-transform duration-300 group-hover:scale-[1.04]"
                  />
                </button>
              );
            })}
          ...
          <div className="order-1 flex-1 md:order-2">
            <div className="relative overflow-hidden rounded-[2rem] border border-[#ede7dc] bg-gradient-to-br from-[#fffdf9] via-[#fbf7f0] to-[#f5efe6] shadow-[0_18px_45px_rgba(60,41,18,0.07)]">
      ...
      <div className="relative">
        <div className="rounded-[2rem] border border-[#ede7dc] bg-[linear-gradient(180deg,rgba(255,253,249,0.96),rgba(250,246,239,0.96))] p-6 shadow-[0_18px_45px_rgba(60,41,18,0.06)] sm:p-8">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#eadfce] bg-[#faf5ed] px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.24em] text-[#6f5a45]">
            <Sparkles className="h-3.5 w-3.5 text-[#b08968]" />
            Editorial Select
          </div>

          <h1 className="mt-4 text-3xl font-semibold leading-tight text-[#2d241c] sm:text-4xl">
            {normalized.name}
          </h1>

          <div className="mt-4 flex flex-wrap items-center gap-3">
            <div className="inline-flex items-center gap-1 rounded-full border border-[#eee6da] bg-white px-3 py-2">
          ...
          <div className="mt-7 rounded-[1.5rem] border border-[#efe7db] bg-gradient-to-r from-[#fffdfa] via-[#faf6ef] to-[#f7f1e8] p-5">
            <div className="flex flex-wrap items-end gap-3">
              <p className="text-3xl font-bold text-[#2d241c]">
                {currency}
                {normalized.price}
              </p>
          ...
          {normalized.description ? (
            <p className="mt-6 text-[15px] leading-8 text-[#5f5145]">
              {normalized.description}
            </p>
          ) : null}
            ...
            <button
              ...
              className={`group inline-flex items-center gap-2 rounded-full px-8 py-3.5 text-sm font-semibold transition-all duration-300 ${
                isOutOfStock
                  ...
                  : "bg-[#2f2419] text-white shadow-[0_14px_30px_rgba(47,36,25,0.16)] hover:-translate-y-0.5 hover:bg-[#3a2d21]"
              }`}
            >
          ...
          <div className="grid gap-4 text-[#5f5145]">
            <div className="flex items-start gap-3 rounded-2xl border border-[#efe7db] bg-[#fffdfa] p-4">
