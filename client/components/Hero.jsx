          ...
          <div className='relative z-10 p-5 sm:p-10 lg:p-14 flex flex-col justify-between min-h-[82vh]'>
            ...
            <div className="max-w-3xl">
              <Link
                ...
                "
              >
                <span className="bg-gradient-to-r from-[#6d28d9] via-[#8b5cf6] to-[#3b82f6] px-4 py-1.5 rounded-full text-white text-sm sm:text-base font-[Garamond] font-semibold shadow-md">
                  Plus Member
                </span>

                <span className="hidden sm:inline text-[13px] lg:text-[15px] font-medium text-stone-800 font-[Garamond] tracking-[0.01em]">
                  Earn points faster, unlock reward promos, and enjoy premium perks.
                </span>
              </Link>
