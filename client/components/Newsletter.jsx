...
const Newsletter = () => {
  ...
  return (
    <section className="relative overflow-hidden px-6 md:px-10 my-28 max-w-7xl mx-auto">
      <div className="absolute -top-16 left-0 h-56 w-56 rounded-full bg-[#689ff7]/20 blur-3xl -z-10" />
      <div className="absolute top-20 right-0 h-72 w-72 rounded-full bg-[#d9b1fc]/20 blur-3xl -z-10" />
      <div className="absolute bottom-0 left-1/3 h-64 w-64 rounded-full bg-[#e6b57e]/20 blur-3xl -z-10" />

      <div className="rounded-[2rem] border border-white/60 bg-white/65 p-6 shadow-[0_20px_70px_rgba(217,177,252,0.10)] backdrop-blur-xl md:p-10">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mt-6">
            ...
            <h2 className={`${playfair.className} mt-2 text-4xl sm:text-5xl md:text-6xl leading-none font-semibold bg-gradient-to-r from-[#689ff7] via-[#d9b1fc] to-[#e6b57e] bg-clip-text text-transparent`}>
              The Charis Journal
            </h2>

            <div className="mt-4 flex items-center justify-center gap-3">
              <div className="h-px w-10 bg-gradient-to-r from-transparent to-[#689ff7]" />
              <div className="h-2 w-2 rounded-full bg-gradient-to-r from-[#689ff7] via-[#d9b1fc] to-[#e6b57e]" />
          ...
          <form onSubmit={handleSubmit} className="mt-10 w-full max-w-2xl">
            <div className="flex flex-col gap-3 rounded-[1.75rem] border border-white/70 bg-white/75 p-3 shadow-[0_12px_35px_rgba(217,177,252,0.10)] backdrop-blur-md sm:flex-row sm:items-center">
              <div className="flex flex-1 items-center gap-3 rounded-full bg-white/80 px-4 py-3">
                <Mail className="h-5 w-5 text-[#689ff7]" />
                <input
                  type="email"
                  value={email}
              ...
              <button
                type="submit"
                disabled={loading}
                className={`inline-flex items-center justify-center gap-2 rounded-full px-6 py-3 text-sm font-semibold text-white shadow-[0_14px_35px_rgba(217,177,252,0.25)] transition-all duration-300 ${
                  loading
                    ? 'cursor-not-allowed bg-slate-300'
                    : 'bg-gradient-to-r from-[#689ff7] via-[#d9b1fc] to-[#e6b57e] hover:-translate-y-0.5 hover:shadow-[0_18px_40px_rgba(217,177,252,0.35)]'
                }`}
              >
